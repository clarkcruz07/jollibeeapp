...
export const Buttons = () =>{
    ...
    const getURL = window.location.pathname
       useEffect(() => {
        if(getURL == '/grab'){
            ...
            document.getElementById('jbbtn').style.pointerEvents = "none"
        }
    ...
    return (
        <div className="btn-wrapper">
            ...
            <Link to="/jollibee"><button className="btn btn-jollibee" id="jollibee"><img src={jollibeeLogo} alt="Jollibee Logo" id="jbbtn"/></button></Link>
